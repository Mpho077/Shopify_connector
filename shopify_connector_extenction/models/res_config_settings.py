...
class ResConfigSettings(models.TransientModel):
    ...
    shopify_auto_create_invoice = fields.Boolean(
        ...
        config_parameter='shopify_connector_extension.auto_create_invoice',
    )
    shopify_auto_register_payment = fields.Boolean(
        string="Auto-Register Payment",
        config_parameter='shopify_connector_extension.auto_register_payment',
    )
    ...
    def set_values(self):
        ...
        self.env['ir.config_parameter'].sudo().set_param(
            'shopify_connector_extension.payment_journal_id',
    ...
    def get_values(self):
        ...
        journal_id = int(self.env['ir.config_parameter'].sudo().get_param(
            'shopify_connector_extension.payment_journal_id', '0'
        ))
        if journal_id:
